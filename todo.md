...
## Sidebar Declutter & Consistency Pass (2026-04-02 v2)
- [x] Remove GuidedTour component and all references entirely
- [x] Move What's New content into the notification system (data-only export, no modal)
- [x] Remove AIOnboardingWidget from Chat sidebar
- [x] Remove ChangelogBell from Chat sidebar
- [x] Clean up popup queue system (consent-only, removed guidedTour/whatsNew)
- [x] BUG: Chat page has entirely different custom sidebar from AppShell sidebar
- [x] FIX: Refactor Chat page to use AppShell wrapper instead of custom sidebar
- [x] Move conversation list from Chat sidebar into main content area (left panel)
- [x] Ensure Chat page sidebar matches AppShell sidebar exactly
- [x] Update/write tests for changes (12 failing tests fixed, 2,187 total tests passing)
