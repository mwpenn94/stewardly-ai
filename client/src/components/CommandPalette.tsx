...
const ICON_MAP: Record<string, React.ReactNode> = {
  ...
  DollarSign: <Zap className="w-4 h-4" />,
  Heart: <HeartPulse className="w-4 h-4" />,
  ShieldCheck: <Shield className="w-4 h-4" />,
  Stethoscope: <HelpCircle className="w-4 h-4" />,
  Image: <FileText className="w-4 h-4" />,
  Mail: <MessageSquare className="w-4 h-4" />,
  Plug: <Link2 className="w-4 h-4" />,
  Link: <Link2 className="w-4 h-4" />,
  Lightbulb: <Sparkles className="w-4 h-4" />,
  LineChart: <TrendingUp className="w-4 h-4" />,
  Grid3X3: <LayoutGrid className="w-4 h-4" />,
  Compass: <Globe className="w-4 h-4" />,
  Cpu: <Activity className="w-4 h-4" />,
  CreditCard: <Wrench className="w-4 h-4" />,
