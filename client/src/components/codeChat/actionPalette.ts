...
export const DEFAULT_ACTIONS: PaletteAction[] = [
  ...
  { id: "tab:health", label: "Workspace health dashboard", category: "tab", hint: "g q", keywords: ["health", "score", "dashboard", "quality", "overview"] },
  ...
  { id: "open:subagents", label: "Open subagents", category: "popover", keywords: ["agents", "task", "specialist", "reviewer", "tester"] },
