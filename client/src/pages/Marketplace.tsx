      ...
      <div className="max-w-6xl mx-auto px-4 pt-4">
        <div className="flex items-start gap-2 p-3 rounded-lg bg-amber-500/5 border border-amber-500/10">
          ...
          <p className="text-[10px] text-zinc-500 leading-relaxed">
            <strong className="text-zinc-400">Disclosure:</strong> Stewardry may receive compensation from advisors or product providers listed in this marketplace.
            ...
            Stewardry does not guarantee the accuracy of information provided by third-party advisors or product providers.
          </p>
        </div>
      </div>
