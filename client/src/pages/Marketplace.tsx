...
export default function Marketplace() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      {/* Conflict of Interest Disclosure (3C) */}
      <div className="max-w-6xl mx-auto px-4 pt-4">
        <div className="flex items-start gap-2 p-3 rounded-lg bg-amber-500/5 border border-amber-500/10">
          <Shield className="w-3.5 h-3.5 text-amber-500/70 shrink-0 mt-0.5" />
          <p className="text-[10px] text-zinc-500 leading-relaxed">
            <strong className="text-zinc-400">Disclosure:</strong> Stewardly may receive compensation from advisors or product providers listed in this marketplace.
            Advisor match scores and product comparisons are generated by AI and are not endorsements.
            Always conduct your own due diligence and verify credentials independently before engaging any advisor or purchasing any product.
            Stewardly does not guarantee the accuracy of information provided by third-party advisors or product providers.
          </p>
        </div>
      </div>
