...
const GUIDE_SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    features: [
      { name: "Compound Interest Calculator", desc: "Calculate compound growth with customizable parameters.", route: "/wealth-engine" },
      { name: "Loan Amortization", desc: "Full amortization schedules with payment breakdowns.", route: "/wealth-engine" },
      { name: "Retirement Projections", desc: "Monte Carlo simulations with configurable scenarios and success rates.", route: "/wealth-engine" },
      { name: "IUL Illustrations", desc: "Indexed Universal Life back-testing with S&P 500 historical data.", route: "/wealth-engine" },
      { name: "Premium Finance ROI", desc: "Premium finance return-on-investment analysis with SOFR-based rates.", route: "/wealth-engine" },
      { name: "What-If Scenarios", desc: "Scenario modeling for financial decisions with side-by-side comparison.", route: "/wealth-engine" },
      { name: "Tax Projector", desc: "Multi-year tax projection with Roth conversion analysis and bracket optimization.", route: "/wealth-engine" },
      { name: "Social Security Optimizer", desc: "Optimize Social Security claiming strategy with spousal benefit analysis.", route: "/wealth-engine" },
      { name: "Medicare Navigator", desc: "Navigate Medicare enrollment windows, Part D plans, and IRMAA surcharges.", route: "/wealth-engine" },
      { name: "HSA Optimizer", desc: "Health Savings Account contribution and investment strategy optimization.", route: "/wealth-engine" },
      { name: "Divorce Analysis", desc: "Asset division modeling, alimony projections, and equitable distribution analysis.", route: "/wealth-engine" },
      { name: "Education Planner", desc: "529 plan projections and education funding strategy with financial aid impact.", route: "/wealth-engine" },
      { name: "Charitable Giving", desc: "Donor-advised fund, QCD, and charitable remainder trust strategy optimization.", route: "/wealth-engine" },
      { name: "Income Streams", desc: "Model multiple income sources with growth rates, tax treatments, and pillar contributions.", route: "/wealth-engine" },
      { name: "PDF Export", desc: "Export any calculator result as a branded PDF report with compliance disclaimers.", route: "/wealth-engine" },
    ],
  },
  {
      ...
      <div className="max-w-5xl mx-auto px-4 py-8 space-y-8">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-muted-foreground text-sm max-w-lg mx-auto">
            Comprehensive guide to all 134 pages, 357+ services, and 97 API routers powering your digital financial twin.
          </p>
        </div>
