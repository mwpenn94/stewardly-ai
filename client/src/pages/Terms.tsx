          ...
          <section>
            ...
            <div className="space-y-6 text-sm text-foreground/85 leading-relaxed">
              <div>
                ...
                <p>By accessing or using this Personal AI platform ("Service"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you may not use the Service. Your continued use of the Service constitutes acceptance of any updates to these Terms.</p>
              </div>
