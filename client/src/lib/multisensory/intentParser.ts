...
export const ROUTE_MAP: Record<string, string> = {
  ...
  "exam": "/learning/exam",
  "exam simulator": "/learning/exam",
  "connection map": "/learning/connection-map",
  "concept map": "/learning/connection-map",
...
export function friendlyRouteName(path: string): string {
  const exact: Record<string, string> = {
    ...
    "/learning/exam": "Exam Simulator",
    "/learning/connection-map": "Connection Map",
    "/settings": "Settings",
