...
export const TOOLS_NAV: NavItemDef[] = [
  ...
  { iconName: "Calculator", label: "Wealth Engine", href: "/wealth-engine", minRole: "user", section: "intelligence" },
  ...
  { iconName: "Database", label: "Data Pipelines", href: "/data-pipelines", minRole: "admin", section: "relationships" },
  { iconName: "Zap", label: "Outreach Automation", href: "/outreach-automation", minRole: "advisor", section: "relationships" },
