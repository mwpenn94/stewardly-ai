...
- Name: 23-auth-gating.spec.ts >> Auth Gating — No Console Errors on Protected Routes >> /passive-actions shows no critical console errors
- Location: e2e/23-auth-gating.spec.ts:39:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/passive-actions
Call log:
  - navigating to "http://localhost:3000/passive-actions", waiting until "domcontentloaded"
