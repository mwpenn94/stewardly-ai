...
- Name: 23-auth-gating.spec.ts >> Auth Gating — Public Routes Accessible >> /help loads without authentication
...
Call log:
  - navigating to "http://localhost:3000/help", waiting until "domcontentloaded"
