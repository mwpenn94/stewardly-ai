...
- Name: 23-auth-gating.spec.ts >> Auth Gating — Public Routes Accessible >> /integrations loads without authentication
- Location: e2e/23-auth-gating.spec.ts:23:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/integrations
Call log:
  - navigating to "http://localhost:3000/integrations", waiting until "domcontentloaded"
