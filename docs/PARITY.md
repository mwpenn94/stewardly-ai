...
Pass 19 · angle: performance · queue: G16-UI follow-on · shipped: useMemo virtWindow + virtVisibleSet + messages.map skip-on-out-of-window + placeholder card with bookmark/outline hint + bookmarks act as pinned anchors · deferred: G5, G6, G8, G9, G11, G12-UI, G18, G22, G24
