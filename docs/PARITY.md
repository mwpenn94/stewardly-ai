...
Pass 12 · angle: bundle size · queue: G17 (lazy popovers) · shipped: 17 lazy popovers + Suspense gating + DEFAULT_ENABLED_TOOLS split — CodeChat chunk 318KB → 148KB (-53%) · deferred: G5, G6, G8, G9, G11–G13, G16, G18, G22–G24
