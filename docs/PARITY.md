...
| PARITY-CALC-0006      | Multi-strategy stress test (same crisis across all strategies) | wealth_engine | open | P2 | build | 0 | | Found by CBL15 Pass 1. Currently stress tests only run on the winner strategy. Should run all 7 strategies through 3 crisis scenarios and show a comparison table. |
