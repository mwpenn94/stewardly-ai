...
| PARITY-CALC-0004      | Planning stub pages disconnected from backends   | calculators    | open         | P1       | build      | 0     |             | Tax Planning, Estate Planning, Risk Assessment, Income Projection, Insurance Analysis, Protection Score cards on Calculators page link to stub pages that aren't wired to the real Tax Projector / Estate Parser / etc. backends. |
