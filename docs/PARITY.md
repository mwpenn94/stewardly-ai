...
| G2  | Wire profile store into remaining calculators (PF, TaxProjector, SocialSecurity, HSA, Charitable, Divorce, Education) | planning | P1 | in_progress | build | pass 2 (IUL) | 0.2 | Retirement + QuickQuote + IUL done. 7 more calculators need the banner + prefill handler. |
