...
| PARITY-TAX-0002       | Per-lot basis tracking                   | tax_planning         | open         | P3       | build      | 0     |             | Follow-up to PARITY-TAX-0001. Track cost basis + holding period per tax lot for TLH and charitable donation optimization.                              |
