...
| PARITY-CALC-0005      | Calculator pages consistent brand + a11y | wealth_engine        | open         | P2       | build      | 0     |             | Some calculator pages use raw hex colors instead of semantic tokens. Step progress bar in QuickQuote uses hardcoded #e2e8f0. ScoreRing uses raw colors. |
