...
| PARITY-TYPE-0003      | 182 `return null as any` across 32 server services    | type_safety    | open         | P1       | build      | 0     |             | compliancePrescreening(5), proactiveEscalation(8), regBIDocumentation(16), knowledgeBase(12), snapTrade(10), etc. Silent failures in compliance/financial paths when DB unavailable. Needs systematic approach — too many to fix in one pass. |
