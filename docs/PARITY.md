...
| PARITY-CALC-0007      | UWE configurator page missing | calculators | open | P2 | build | 0 | | Found by CBL15 Pass 1. BIE has a configurator page but UWE (universal wealth engine) has no standalone configurator. Users can only use the embedded IUL/PremFin/Retirement calculators. |
