...
| PARITY-ERR-0005       | No route-level ErrorBoundary on wealth-engine pages  | error_states   | open         | P2       | build      | 0     |             | Retirement, StrategyComparison, WhatIfSensitivity, BusinessIncome, QuickQuoteFlow not wrapped in ErrorBoundary. Rendering crash = white screen. |
