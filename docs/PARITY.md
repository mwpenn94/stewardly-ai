...
Pass 10 · angle: accessibility · queue: G15 (a11y audit) · shipped: aria-labels on 6 unlabeled buttons + focus-visible rings + role=log/aria-live/aria-busy on messages container + a11yLint.test.ts regression lint · deferred: G5–G9, G11–G13, G16–G18, G22–G24
