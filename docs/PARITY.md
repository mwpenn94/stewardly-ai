...
Pass 11 · angle: feature completeness · queue: G7 (task subagent) · shipped: TaskRunner injection point + dispatcher case + recursion-guarded sub-ReAct-loop in stream route + SSE subagent_* events + 5 dispatcher tests · deferred: G5, G6, G8, G9, G11–G13, G16–G18, G22–G24
