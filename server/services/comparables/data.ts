...
export const COMPARABLES: readonly ComparableApp[] = [
  ...
  // ── Pass 8 additions (PARITY-CATALOG-0001) ────────────────────────
  {
    id: "addepar",
    name: "Addepar",
    vendor: "Addepar, Inc.",
    ...
    pitch: "HNW portfolio accounting + performance for family offices and RIAs.",
    strengths: [
      "Deep alt-investments support (PE, real estate, hedge)",
      "Powerful multi-entity reporting",
      "Strong data model for complex portfolios",
    ],
    gaps: [
      "Enterprise pricing",
    ...
    overlapsWith: ["portfolio_mgmt", "api_first"],
    sourceNotes: "2026-04 addepar.com + T3 coverage.",
  },
  {
    id: "tamarac",
    name: "Tamarac",
    vendor: "Envestnet (Tamarac)",
    category: "portfolio_mgmt",
    status: "shipping",
    since: 2005,
    url: "https://envestnet.com/tamarac",
    pitch: "Portfolio management + rebalancing + CRM for RIAs.",
    strengths: [
      "Integrated CRM + portfolio + rebalancer",
    ...
    overlapsWith: ["portfolio_mgmt", "rebalancing", "crm_sync"],
    sourceNotes: "2026-04 envestnet.com/tamarac.",
  },
  {
    id: "blackdiamond",
    name: "Black Diamond",
    ...
    status: "shipping",
    since: 2010,
    url: "https://sscblackdiamond.com",
    pitch: "Cloud portfolio reporting platform for wealth managers.",
    strengths: [
      "Open API + integration marketplace",
      "Strong reporting customization",
    ],
    gaps: [
      "Slower innovation cycle than Altruist",
    ],
    features: [
      { axis: "portfolio_mgmt", score: 3 },
      { axis: "rebalancing", score: 2 },
    ...
    overlapsWith: ["portfolio_mgmt", "api_first"],
    sourceNotes: "2026-04 sscblackdiamond.com.",
  },
  {
    id: "morningstar-office",
    name: "Morningstar Office",
    vendor: "Morningstar, Inc.",
    category: "portfolio_mgmt",
    status: "shipping",
    since: 2004,
    url: "https://morningstar.com/products/office",
    pitch: "Research + portfolio management for advisors bundled with Morningstar data.",
    strengths: [
      "Deep fundamental + fund research",
      "Name-brand data",
    ],
    gaps: [
      "Older UI",
      "Less nimble than cloud-native peers",
    ],
    features: [
      { axis: "portfolio_mgmt", score: 2 },
      { axis: "tax_planning", score: 2 },
    ...
    overlapsWith: ["portfolio_mgmt", "wealth_calculators"],
    sourceNotes: "2026-04 morningstar.com/products/office.",
  },
  {
    id: "advicepay",
    name: "AdvicePay",
    vendor: "AdvicePay, Inc.",
    category: "compliance_crm",
    status: "shipping",
    since: 2018,
    url: "https://advicepay.com",
    pitch: "Fee-for-service billing + compliance for financial planners.",
    strengths: [
      "Purpose-built fee billing workflow",
      "Compliance-aware payment flows (NIGO prevention)",
    ],
    gaps: [
      "Billing-only scope — no planning or portfolio",
    ],
    features: [
      { axis: "compliance_archive", score: 2 },
      { axis: "crm_sync", score: 2 },
    ],
    overlapsWith: ["compliance_archive"],
    sourceNotes: "2026-04 advicepay.com.",
  },
  {
    id: "catchlight",
    name: "Catchlight",
    vendor: "Fidelity Labs (Catchlight)",
    category: "advisor_copilot",
    status: "shipping",
    since: 2022,
    url: "https://catchlight.ai",
    pitch: "AI-driven lead-to-meeting engagement for advisors.",
    strengths: [
      "Lead scoring + personalized outreach",
      "Fidelity Labs backing",
    ],
    gaps: [
      "Narrow scope — engagement only",
    ],
    features: [
      { axis: "lead_capture", score: 3 },
      { axis: "crm_sync", score: 2 },
      { axis: "multi_model_ai", score: 1 },
    ],
    overlapsWith: ["lead_capture", "crm_sync"],
    sourceNotes: "2026-04 catchlight.ai + Fidelity Labs press.",
  },

  // ── Pass 11 additions (PARITY-CATALOG-0002 — non-US) ──────────────
  {
    id: "sjp",
    name: "St. James's Place",
    vendor: "St. James's Place plc (UK)",
    category: "consumer_finance",
    status: "shipping",
    since: 1991,
    url: "https://sjp.co.uk",
    pitch: "UK's largest wealth manager — partnership model with proprietary funds.",
    strengths: [
      "~£180B AUM, dominant UK brand",
      "End-to-end planning + investment + tax advice",
    ],
    gaps: [
      "Legacy platform tech",
      "Under UK FCA scrutiny for fees",
    ],
    features: [
      { axis: "portfolio_mgmt", score: 3 },
      { axis: "tax_planning", score: 2 },
    ...
    overlapsWith: ["portfolio_mgmt", "client_portal"],
    sourceNotes: "2026-04 sjp.co.uk + FT coverage.",
  },
  {
    id: "schroders",
    name: "Schroders Wealth",
    vendor: "Schroders plc (UK)",
    category: "portfolio_mgmt",
    status: "shipping",
    since: 1804,
    url: "https://schroders.com/en-gb/uk/wealth-management",
    pitch: "UK-listed global asset and wealth manager for institutional + HNW.",
    strengths: [
      "Global footprint + deep fundamental research",
      "Institutional-grade portfolio management",
    ],
    gaps: [
      "Enterprise pricing — not for mass-affluent",
    ],
    features: [
      { axis: "portfolio_mgmt", score: 3 },
      { axis: "rebalancing", score: 2 },
    ...
    overlapsWith: ["portfolio_mgmt"],
    sourceNotes: "2026-04 schroders.com.",
  },
  {
    id: "aj-bell",
    name: "AJ Bell",
    vendor: "AJ Bell plc (UK)",
    category: "portfolio_mgmt",
    status: "shipping",
    since: 1995,
    url: "https://ajbell.co.uk",
    pitch: "UK-listed low-cost platform for DIY investors and advised clients.",
    strengths: [
      "Strong self-direct platform",
      "Advisor-facing Investcentre product",
    ],
    gaps: [
      "Narrow geographic focus (UK only)",
    ],
    features: [
      { axis: "portfolio_mgmt", score: 3 },
      { axis: "client_portal", score: 3 },
    ...
    overlapsWith: ["portfolio_mgmt", "mobile_app"],
    sourceNotes: "2026-04 ajbell.co.uk.",
  },
  {
    id: "nomura-wealth",
    name: "Nomura Wealth",
    vendor: "Nomura Holdings (Japan)",
    category: "consumer_finance",
    status: "shipping",
    since: 1925,
    pitch: "Japanese megabank wealth arm serving APAC HNW.",
    strengths: [
    ...
    gaps: [
      ...
      "Japan-centric platform",
    ],
    features: [
      { axis: "portfolio_mgmt", score: 2 },
      { axis: "estate_planning", score: 2 },
      { axis: "client_portal", score: 1 },
    ],
    overlapsWith: ["portfolio_mgmt"],
    sourceNotes: "2026-04 nomura.com + T3 Asia coverage.",
  },
  {
    id: "netwealth",
    name: "Netwealth",
    vendor: "Netwealth Group (AU)",
    category: "portfolio_mgmt",
    status: "shipping",
    since: 1999,
    url: "https://netwealth.com.au",
    pitch: "Australia's leading independent wealth platform.",
    strengths: [
      "ASX-listed, ~$90B FUA",
      "Strong API and advisor-facing tooling",
    ],
    gaps: [
      "Australia-only",
    ],
    ...
    overlapsWith: ["portfolio_mgmt", "api_first"],
    sourceNotes: "2026-04 netwealth.com.au.",
  },
  {
    id: "bettermentdach",
    name: "Scalable Capital",
    vendor: "Scalable Capital GmbH (DE)",
    category: "robo_advisor",
    status: "shipping",
    since: 2014,
    url: "https://scalable.capital",
    pitch: "European robo-advisor + broker platform operating in DE/AT/NL/FR.",
    strengths: [
      "Dominant DACH robo presence",
      "Regulated under BaFin + EU MiFID",
    ],
    gaps: [
      "No advisor distribution layer",
    ],
    features: [
      { axis: "portfolio_mgmt", score: 3 },
      { axis: "rebalancing", score: 3 },
    ...
    overlapsWith: ["portfolio_mgmt", "rebalancing", "mobile_app"],
    sourceNotes: "2026-04 scalable.capital + BaFin filings.",
  },
];
